    ...
    private void displayTrip(){
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                //Toast.makeText(getApplicationContext(), trip_name, Toast.LENGTH_SHORT).show();
                ...
                for(cursor2.moveToFirst(); !cursor2.isAfterLast(); cursor2.moveToNext()){
                    ...
                    trip.setName(cursor2.getString(1));
                    trip.setDate(cursor2.getString(2));
                    trip.setMeetingTime(cursor2.getString(3));
                    trip.setLocation(cursor2.getString(4));
                    trip.setMeetingLocation(cursor2.getString(5));
                }


                Cursor locDb = db.rawQuery("select * from " + TripDatabaseHelper.LOCATION_TABLE
                        + " where " + TripDatabaseHelper.LOCATION_TRIP_NO + " = " + trip_name, null);
                ...
                for(cursor1.moveToFirst(); !cursor1.isAfterLast(); cursor1.moveToNext()){
                    ...
                    Log.d("ViewTripHer", "Phone No is " + cursor1.getString(6));
                    friends.add(p);
                }
